...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        choices=['atari'],
        help=
        "It's used for switching between different domains(default: %(default)s)"
    )
    ...
    parser.add_argument('--cpu_actor',
                        type=int,
                        default=14,
                        help='batch cpu actor')
    parser.add_argument('--gpu_actor',
                        type=int,
                        default=20,
                        help='batch bpu actor')
    parser.add_argument('--p_mcts_num',
                        type=int,
                        default=8,
    ...
    parser.add_argument(
        ...
        default=0.99,
        help=
        'Rate at which target policy is re-estimated (default: %(default)s)')
    parser.add_argument('--use_root_value',
                        action='store_true',
                        default=False,
    ...
    parser.add_argument('--augmentation',
                        ...
                        nargs='+',
                        choices=[
                            'none', 'rrc', 'affine', 'crop', 'blur', 'shift',
                            'intensity'
                        ],
    ...
    parser.add_argument('--object_store_memory',
                        type=int,
    ...
    logging.getLogger('train').info('Param: {}'.format(
        game_config.get_hparams()))
